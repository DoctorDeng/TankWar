...
public class BasicButton extends JButton {
	...
	public static final Color BUTTON_COLOR1 = new Color(9, 163, 220);
	public static final Color BUTTON_COLOR2 = new Color(60, 195, 245);
...
//			color1 = BUTTON_BAK_COLOR2_1;
		...
		if (getModel().isPressed()) {
			p1 = new GradientPaint(0, 0, new Color(209, 209, 209), 0, h - 1,
					new Color(21, 131, 221));
//			p2 = new GradientPaint(0, 1, new Color(0, 0, 0, 50), 0, h - 3,
//					new Color(255, 255, 255, 100));
		} else {
			p1 = new GradientPaint(0, 0, new Color(21, 131, 221), 0, h - 1,
...
//		g2d.drawRoundRect(1, 1, w - 3, h - 3, 10, 10);
	 ...
	 BasicButton button = new BasicButton("222");
//	 field.setColumns(10);
